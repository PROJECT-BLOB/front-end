...
export default function NotificationItem({ notification }: { notification: Notification }) {
  function handleClickDeleteNotification() {
    const { data } = useReadNotification(notification.notificationId);
    console.log(notification.notificationId, '번 알림을 삭제합니다.', data);
  }
  ...
  return (
    <div className={cx('container')}>
      ...
      <span className={cx('content')}>{notification.message}</span>
      <span className={cx('icon')}>
